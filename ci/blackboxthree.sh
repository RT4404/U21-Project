...
show_usage()
{
echo "Extended Vortex BlackBox Test Driver v1.0"
...
echo "--warps=<number>"
echo "--threads=<number>"
echo "--barriers=<number>"
echo "--socket_size=<size>"
echo "--xlen=<bits>"
echo "--flen=<bits>"
...
echo "--l2cache"
echo "--l3cache"
echo "--l1cache_disable"
echo "--l1_line_size=<size>"
echo "--num_icaches=<number>"
echo "--icache_size=<size>"
echo "--icache_num_ways=<ways>"
echo "--icache_mreq_size=<size>"
echo "--icache_mshr_size=<size>"
echo "--icache_crsq_size=<size>"
echo "--icache_mrsq_size=<size>"
echo "--icache_disable"
echo "--num_dcaches=<number>"
echo "--dcache_writeback=<policy>"
echo "--dcache_size=<size>"
echo "--dcache_num_ways=<ways>"
echo "--dcache_mreq_size=<size>"
echo "--dcache_mshr_size=<size>"
echo "--dcache_crsq_size=<size>"
echo "--dcache_mrsq_size=<size>"
echo "--dcache_num_banks=<banks>"
echo "--dcache_repl_policy=<policy>"
echo "--dcache_dirtybytes=<bytes>"
echo "--dcache_disable"
echo "--l2_writeback=<policy>"
echo "--l2_size=<size>"
echo "--l2_num_ways=<ways>"
echo "--l2_mreq_size=<size>"
echo "--l2_mshr_size=<size>"
echo "--l2_crsq_size=<size>"
echo "--l2_mrsq_size=<size>"
echo "--l2_banks=<banks>"
echo "--l3_writeback=<policy>"
echo "--l3_size=<size>"
echo "--l3_num_ways=<ways>"
echo "--l3_mreq_size=<size>"
echo "--l3_mshr_size=<size>"
echo "--l3_crsq_size=<size>"
echo "--l3_mrsq_size=<size>"
echo "--l3_banks=<banks>"

echo ""
echo "Memory System Configs:"
echo "--memory_banks=<banks>"
echo "--num_mem_ports=<ports>"
echo "--mem_block_size=<size>"
echo "--mem_addr_width=<width>"
echo "--stack_log2_size=<log_size>"
echo "--stack_size=<size>"
echo "--stack_base_addr=<address>"
echo "--startup_addr=<address>"
echo "--user_base_addr=<address>"
echo "--io_base_addr=<address>"
echo "--page_table_base_addr=<address>"
echo "--mem_page_size=<size>"
echo "--mem_page_log2_size=<log_size>"

echo ""
echo "Local Memory Configs:"
echo "--lmem_enable"
echo "--lmem_disable"
echo "--lmem_base_addr=<address>"
echo "--lmem_log_size=<log_size>"
echo "--lmem_num_banks=<banks>"

echo ""
echo "Execution Unit Configs:"
echo "--num_alu_lanes=<lanes>"
echo "--num_fpu_lanes=<lanes>"
echo "--num_lsu_lanes=<lanes>"
echo "--num_sfu_lanes=<lanes>"
echo "--num_alu_blocks=<blocks>"
echo "--num_fpu_blocks=<blocks>"
echo "--num_lsu_blocks=<blocks>"
echo "--num_sfu_blocks=<blocks>"

echo ""
echo "Latency and FPU Configs:"
echo "--fpuq_size=<size>"
echo "--latency_imul=<cycles>"
echo "--latency_fma=<cycles>"
echo "--latency_fdiv=<cycles>"
echo "--latency_fsqrt=<cycles>"
echo "--latency_fcvt=<cycles>"
echo "--latency_fncp=<cycles>"
echo "--fma_pe_ratio=<ratio>"
echo "--fdiv_pe_ratio=<ratio>"
echo "--fsqrt_pe_ratio=<ratio>"
echo "--fcvt_pe_ratio=<ratio>"
echo "--fncp_pe_ratio=<ratio>"

echo ""
echo "Pipeline Configs:"
echo "--issue_width=<width>"
echo "--ibuf_size=<size>"
echo "--lsu_line_size=<size>"
echo "--lsuq_in_size=<size>"
echo "--lsuq_out_size=<size>"
echo "--gbar_enable"

echo ""
echo "Virtual Memory Configs:"
echo "--vm_enable"
echo "--vm_addr_mode=<mode>"
echo "--pt_level=<levels>"
echo "--pte_size=<size>"
echo "--num_pte_entry=<entries>"
echo "--pt_size_limit=<limit>"
echo "--pt_size=<size>"
echo "--tlb_size=<size>"

echo ""
echo "ISA Extension Configs:"
echo "--ext_m_disable"
echo "--ext_f_disable"
echo "--ext_d_disable"
echo "--ext_c_disable"
echo "--ext_a_disable"
echo "--ext_zicond_disable"

echo ""
echo "Tensor Core Configs:"
echo "--tc_size=<size>"
echo "--tc_num=<number>"
echo "--num_tcu_lanes=<lanes>"
echo "--num_tcu_blocks=<blocks>"

echo ""
echo "DPI and Synthesis Options:"
echo "--fpu_dpi"
echo "--imul_dpi"
echo "--dpi_disable"
echo "--idiv_dpi"
...
echo ""
echo "FPU_FPNEW Configs:"
echo "--fpu_fpnew"

echo ""
echo "Platform Configs:"
echo "--platform_memory_banks=<banks>"
echo "--platform_memory_addr_width=<width>"
echo "--platform_memory_interleave=<policy>"

echo ""
echo "Verilator Configs:"
echo "--verilator_reset_value=<value>"

echo ""
echo "I/O Configs:"
echo "--io_cout_size=<size>"
echo "--io_mpm_size=<size>"

echo ""
echo "Performance/Debug Options:"
echo "--perf=<class>"
echo "--debug=<level>"
echo "--scope"
echo "--args=<arguments>"
