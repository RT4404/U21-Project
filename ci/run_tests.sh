...
run_test() {
    ...
    local log_dir=$2
    local timeout_duration=1800 # Timeout in seconds (adjust as needed)
...
baseline_tests(){
	...
	DIR="$ROOT_DIR/Baseline/sgemm"
	run_test "--driver=rtlsim --app=sgemm" "$DIR"
	run_test "--driver=simx --app=sgemm" "$DIR"
	...
	# Argument of n1 to fairly compare with cores_clustering
	run_test "--driver=rtlsim --app=diverge --args=\"-n1\"" "$DIR"
	run_test "--driver=simx --app=diverge --args=\"-n1\"" "$DIR"
...
cache_tests(){
	...
	run_test "--driver=rtlsim --app=sgemmx --l1cache_disable --lmem_disable" "$DIR"
	run_test "--driver=rtlsim --app=sgemmx --l1cache_disable" "$DIR"
	...
	run_test "--driver=rtlsim --app=diverge --clusters=4 --l3cache --socket_size=1 --args=\"-n1\"" "$DIR"
	run_test "--driver=rtlsim --app=diverge --cores=2 --clusters=2 --l3cache --socket_size=1 --args=\"-n1\"" "$DIR"
	run_test "--driver=rtlsim --app=diverge --cores=2 --clusters=2 --l2cache --socket_size=1 --args=\"-n1\"" "$DIR"
	run_test "--driver=rtlsim --app=diverge --cores=2 --clusters=2 --l2cache --l3cache --socket_size=1 --args=\"-n1\"" "$DIR"
	# Testing L2/L3 configs on sgemm
	run_test "--driver=rtlsim --app=sgemm --cores=4" "$DIR"
	run_test "--driver=rtlsim --app=sgemm --cores=4 --l2cache" "$DIR"
	run_test "--driver=rtlsim --app=sgemm --clusters=4" "$DIR"
	run_test "--driver=rtlsim --app=sgemm --clusters=4 --l3cache" "$DIR"
	run_test "--driver=rtlsim --app=sgemm --cores=2 --clusters=2" "$DIR"
	run_test "--driver=rtlsim --app=sgemm --cores=2 --clusters=2 --l2cache" "$DIR"
	run_test "--driver=rtlsim --app=sgemm --cores=2 --clusters=2 --l3cache" "$DIR"
	run_test "--driver=rtlsim --app=sgemm --cores=2 --clusters=2 --l2cache --l3cache" "$DIR"
}
...
basic_config1_tests(){
	...
	# Warps
	run_test "--driver=rtlsim --warps=1 --app=diverge" "$DIR"
	run_test "--driver=rtlsim --warps=2 --app=diverge" "$DIR"
	run_test "--driver=rtlsim --warps=8 --app=diverge" "$DIR"
	# Threads
	run_test "--driver=rtlsim --threads=1 --app=diverge" "$DIR"
	run_test "--driver=rtlsim --threads=2 --app=diverge" "$DIR"
	run_test "--driver=rtlsim --threads=8 --app=diverge" "$DIR"
	# Mix of warps and threads
	...
	run_test "--driver=rtlsim --warps=8 --threads=16 --app=diverge" "$DIR"
	run_test "--driver=rtlsim --warps=16 --threads=8 --app=diverge" "$DIR"
	run_test "--driver=rtlsim --warps=8 --threads=8 --app=diverge" "$DIR"
	run_test "--driver=rtlsim --warps=16 --threads=16 --app=diverge" "$DIR"
	...
	run_test "--driver=rtlsim --clusters=4 --app=diverge --args=\"-n1\"" "$DIR"
